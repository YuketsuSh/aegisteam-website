...
<html lang="en">
<head>
    <title>AegisTeam - Admin Dashboard [Edit Project]</title>
    <!-- Meta -->
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="row">
                ...
                if (isset($_GET['id']) && is_numeric($_GET['id'])) {
                    $projectId = $_GET['id'];
                    $projectQuery = $bdd->prepare("SELECT * FROM works WHERE id = ?");
                ...
                if (isset($_POST['updateWork'])){
                    ...
                    $updateSql = "UPDATE works SET title = ?, category = ?, description = ?, thumbnail = ?, link = ? WHERE id = ?";
                    $updateProject = $bdd->prepare($updateSql);
                    $updateProject->execute([$title, $category, $description, $thumbnail, $link, $projectId]);
                    if ($updateProject) {
                        echo "<p class='alert alert-success'>Project edit has been successfully</p><meta http-equiv='refresh' content='2;url=../system/worklist'>";
                    } else {
                        echo "Error: " . $updateSql . "<br>";
                    }
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="position-relative overflow-hidden rounded">
                                            <img id="previewThumbnail" src="<?= htmlspecialchars($project['thumbnail']) ?>" alt="images" class="w-100">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="title" name="title" placeholder="<?= htmlspecialchars($project['title']) ?>">
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="link" name="link" class="form-control" placeholder="<?= htmlspecialchars($project['link']) ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group form-editor">
                                                    ...
                                                    <textarea class="form-control" id="description" name="description"><?= htmlspecialchars($project['description']) ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="text-end">
                                            <button type="submit" name="updateWork" class="btn btn-primary">Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
